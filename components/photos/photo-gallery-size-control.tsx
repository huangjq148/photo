      ...
      <div className="noir-glass-chip grid grid-cols-3 gap-2 rounded-2xl p-1">
        {sizes.map((size) => (
          <button
            ...
            className={`relative inline-flex h-9 min-w-10 items-center justify-center rounded-xl px-2 text-sm font-medium transition before:absolute before:-inset-y-1 before:inset-x-0 before:content-[''] ${
              value === size.value
